					...
					<view class="goods-info" @tap="toGoods(row)">
						...
						<view class="info">
							...
							<view class="price-number">
								...
								<counter :goodsInfo="row" @sub="sub(row)" @add="add(row)"></counter>
	...
	export default {
		...
		methods: {
			...
			sum() { // 合计
				...
				this.sumPrice = this.sumPrice.toFixed(2); // 四舍五入为指定小数位数的数字
			},
			toConfirmation() { // 结算
